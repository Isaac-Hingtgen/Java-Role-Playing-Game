...
public class Seasons {
    ...
    public static Seasons getCurSeason(int level) {
        Seasons curSeason = null;

        int season = ((int) (level / 4.0)) % 4;
...
class Autumn extends Seasons {
    public Autumn() {
        ...
        description = "Autumn is the time of Thanksgiving and relaxation,"
            + "\nhowever too many pumpkin pies and pumpkin spiced lattes have made the hero sluggish and stupid. "
            + "(-5 evasion, -3 mana per turn)"
